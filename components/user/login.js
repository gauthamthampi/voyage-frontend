    ...
    <section className="bg-white dark:bg-gray-900">
      ...
      <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form className="w-full max-w-md" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            <button className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-orange-500 rounded-lg hover:bg-orange-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
              Sign in
            </button>
            ...
            >
              ...
              <span  onClick={() => signIn("google")} className="mx-2">Sign in with Google</span>
            </a>
            ...
            <div className="mt-6 text-center">
              ...
              >
                Don’t have an account yet? <span className='text-orange-500  hover:underline'>Sign up</span>
              </a>
            </div>
          </div>
        </form>
